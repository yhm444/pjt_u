cmd_scripts/dtc/flattree.o := cc -Wp,-MD,scripts/dtc/.flattree.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64  -std=gnu11    -Iscripts/dtc/libfdt  -c -o scripts/dtc/flattree.o scripts/dtc/flattree.c

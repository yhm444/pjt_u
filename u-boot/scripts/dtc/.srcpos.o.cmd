cmd_scripts/dtc/srcpos.o := cc -Wp,-MD,scripts/dtc/.srcpos.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64  -std=gnu11    -Iscripts/dtc/libfdt  -c -o scripts/dtc/srcpos.o scripts/dtc/srcpos.c

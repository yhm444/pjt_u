cmd_drivers/pinctrl/broadcom/pinctrl-bcm283x.o := aarch64-linux-gnu-gcc -Wp,-MD,drivers/pinctrl/broadcom/.pinctrl-bcm283x.o.d  -nostdinc -isystem /usr/lib/gcc-cross/aarch64-linux-gnu/8/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-strict-aliasing -fno-PIE -Os -fno-stack-protector -fno-delete-null-pointer-checks -Wno-pointer-sign -Wno-stringop-truncation -Wno-array-bounds -Wno-stringop-overflow -Wno-maybe-uninitialized -fmacro-prefix-map=./= -g -fstack-usage -Wno-format-nonliteral -Wno-unused-but-set-variable -Werror=date-time -Wno-packed-not-aligned -D__ARM__ -fno-pic -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe -march=armv8-a -D__LINUX_ARM_ARCH__=8 -I./arch/arm/mach-bcm283x/include    -DKBUILD_BASENAME='"pinctrl_bcm283x"'  -DKBUILD_MODNAME='"pinctrl_bcm283x"' -c -o drivers/pinctrl/broadcom/pinctrl-bcm283x.o drivers/pinctrl/broadcom/pinctrl-bcm283x.c

source_drivers/pinctrl/broadcom/pinctrl-bcm283x.o := drivers/pinctrl/broadcom/pinctrl-bcm283x.c

deps_drivers/pinctrl/broadcom/pinctrl-bcm283x.o := \
...
drivers/pinctrl/broadcom/pinctrl-bcm283x.o: $(deps_drivers/pinctrl/broadcom/pinctrl-bcm283x.o)
